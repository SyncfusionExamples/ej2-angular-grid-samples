# Connecting the Syncfusion Angular Grid with Flask REST backend
...
| `client/src/app/app.component.ts` | Angular Grid configuration and data binding |
| `client/src/app/app.component.html` | Grid template markup |
| `client/src/styles.css` | Global styles including Syncfusion theme |
| `client/angular.json` | Angular CLI configuration |
| `client/package.json` | Angular project dependencies |
...
2. **Copy the GitHub URL**
    ...
    - Example : https://github.com/SyncfusionExamples/ej2-angular-grid-samples/tree/master/connecting-to-backends/syncfusion-angular-grid-with-flaskapi-server-master
